...
import {
    Search, MoreVertical, MessageCircle, UserX,
    User, Loader2, AlertCircle, Flag
} from 'lucide-react';
...
export default function Connections() {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => fetchConnections(), 500);
    ...
    const handleOpenReport = (connection) => {
        setReportTarget({
            userId: connection.user_id,
            userName: connection.profile.full_name,
            userEmail: connection.profile.email || '',
        });
        setMenuOpenId(null);
    ...
    const handleViewProfile = (connection) => {
        setSelectedConnection({
            ...
            interests: connection.profile.interests
        ...
        <>
            ...
            <div className="min-h-screen pt-24 pb-12 px-6 lg:px-8 bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Button onClick={fetchConnections} className="bg-black hover:bg-gray-800">Try Again</Button>
                </div>
            </div>
        </>
    );
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {!hasLoadedOnce.current && loading && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[...Array(4)].map((_, i) => <SkeletonConnectionCard key={i} />)}
                        </div>
                    )}

                    {/* Spinner on subsequent loads */}
                    {hasLoadedOnce.current && loading && (
                        ...
                        >
                            ...
                            <p className="text-gray-500 mb-6">
                                {searchQuery
                                    ...
                                    : 'Start connecting with students in the Discovery page'}
                            </p>
                            {!searchQuery && (
                                <Button
                                ...
                                >
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <div className="relative">
                                            <button
                                                onClick={() =>
                                                    setMenuOpenId(menuOpenId === connection.user_id ? null : connection.user_id)
                                                }
                                                ...
                                                <>
                                                    ...
                                                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-20">
                                                        ...
                                                        >
                                                            ...
                                                            {removingUserId === connection.user_id
                                                                ? 'Removing...'
                                                                : 'Remove Connection'}
                                                        </button>
                                                        <button
                                                            onClick={() => handleOpenReport(connection)}
